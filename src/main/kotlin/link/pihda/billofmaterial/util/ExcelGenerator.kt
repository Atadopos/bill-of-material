...
object ExcelGenerator {
    ...
    fun generateExcelFromTransactions(transactions: List<Transaction>) {
        XSSFWorkbook().use { workbook ->
            ...
            for (transaction in transactions) {
                ...
                transactionHeader.createCell(3).setCellValue("Shipping Rate: ${transaction.shippingRate}")
                transactionHeader.createCell(4).setCellValue("Total Price: ${transaction.totalPrice}")
                transactionHeader.createCell(5).setCellValue("Currency Code: ${transaction.currencyCode.name}")
